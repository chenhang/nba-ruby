...
def parse_league
  ...
  PARAMS.each do |k, v|
    v[1].each_with_index do |_, i|
      json_data = get league_shot_dashboard_api(k, i)
...
File.open("data/league_shots_dashboard.json", "w") do |f|
  f.write(parse_league.to_json)
end